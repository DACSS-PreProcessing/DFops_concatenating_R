...
str(allFragility)
```
Let´s check some possible errors:
```{r}
...
allFragility$Year2=format(as.Date(allFragility$Year, origin="1899-12-30"),"%Y")

allFragility$Year=ifelse(allFragility$Year%in%c(2021,2023),allFragility$Year,allFragility$Year2)
